                ...
                <%@ include file="header.jspf" %>
                            ...
                            <div class="col-md-9 col-lg-10" data-aos="fade-left">
                                ...
                                <div class="glass-card p-4 mb-4">
                                    <h5 class="fw-bold mb-4"><i
                                            class="fa-solid fa-clock-rotate-left me-2 text-primary"></i>Recent Activity
                                    </h5>
                                        ...
                                        <table class="table table-dark table-hover align-middle small">
                                            ...
                                            <tbody>
                                                <c:forEach var="res" items="${recentReservations}">
                                                    <tr>
                                                        <td class="fw-bold">${res.resNo}</td>
                                                        <td>${res.guestName}</td>
                                                        <td>${res.roomInfo}</td>
                                                        <td class="text-center text-info">LKR
                                                            <fmt:formatNumber value="${res.total}" type="number" />
                                                        </td>
                                                        <td class="text-center">
                                                            <span
                                                                class="badge ${res.status == 'PAID' ? 'bg-success' : 'bg-warning'} bg-opacity-10 text-${res.status == 'PAID' ? 'success' : 'warning'} border border-${res.status == 'PAID' ? 'success' : 'warning'} border-opacity-25 px-2 py-1">
                                                                ${res.status}
                                                            </span>
                                                        </td>
                                                    </tr>
                                                ...
                                                <c:if test="${empty recentReservations}">
                                                    <tr>
                                                        <td colspan="5" class="text-center text-muted py-4">No recent
                                                            activity data.</td>
                                                    </tr>
                                                </c:if>
                                            </tbody>
                                ...
                                <div class="row g-4 mb-4">
                                    ...
                                    <div class="col-lg-5">
                                        <div class="glass-card p-4 h-100">
                                            ...
                                            <canvas id="roomPerformanceChart" height="220"></canvas>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <script>
                        document.addEventListener('DOMContentLoaded', function () {
                            ...
                            // 1. Revenue Chart
                            const rawRevenue = '${revenueTrend}';
                            const revenueData = rawRevenue ? JSON.parse(rawRevenue) : [];
                            ...
                            const rawOcc = '${occupancyTrend}';
                            const occData = rawOcc ? JSON.parse(rawOcc) : [];
